            ...
            <div className="container mx-auto">
                ...
                <div className="footer-content flex flex-col lg:flex-row justify-center items-center mb-8">
                    <div className="text-center lg:text-left mb-4 lg:mb-0 lg:mr-8 lg:mb-2">
                        ...
                        <NavLink to="/news" className="text-white mb-2 lg:mb-0 lg:mr-4 ml-4 lg:hover:text-blue-500 block" activeClassName="font-bold news-link">News</NavLink>
                        <NavLink to="/contact" className="text-white mb-2 lg:mb-0 lg:mr-4 ml-2 text-center lg:hover:text-blue-500 block" activeClassName="font-bold">Contact</NavLink>
                        <NavLink to="/support" className="text-white mb-2 lg:mb-0 text-center ml-4 lg:hover:text-blue-500 block" activeClassName="font-bold">Support Us</NavLink>
                    </div>
                </div>
                {/* Social Media Icons */}
                <div className="flex justify-center mb-4 mr-6">
                    <a href="https://www.facebook.com/profile.php?id=61557636222692" target="_blank" rel="noopener noreferrer" className="mr-4 text-white hover:text-blue-500">
                        <FaFacebook size={24} />
                    </a>
                    <a href="https://www.linkedin.com/company/100894893" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-500">
                        <FaLinkedin size={24} />
                    </a>
                </div>
                {/* Contact Section */}
                <div className="footer-contact text-center lg:text-center mb-4 lg:mb-0 lg:mr-4">
                    ...
                    <div>
                        <p>Email: <a href="mailto:info@dzikoccj.org" className="text-white hover:text-blue-500">info@dzikoccj.org</a></p>
                    </div>
                </div>
                {/* Footer Bottom */}
